<?php $__env->startSection('title','Skill question registration'); ?>
                ...
                <form method="post">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <textarea  id="question_content" class="form-control <?php echo e(($errors->first('content')) ? 'is-invalid'  :''); ?>"  name="content" rows=4><?php echo e(old('content')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-control wrapper-select">
                                <select class="select-language" name="type">
                                    <?php $__currentLoopData = $language; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($key); ?>" <?php echo e($key == old('type') ? 'selected' : ''); ?>>
                                           <?php echo e($val); ?>
                    ...
                    <div class="form-group-button">
                        ...
                        <a role="button" href="<?php echo e(url('tech-list')); ?>" class="btn btn-secondary btn-form" >Cancel</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/SelinaNguyen/Documents/SBA/SBA_Interview/resources/views/pages/teach_question_new.blade.php ENDPATH**/ ?>