        ...
        <div class="col-2 d-lg-block d-none res-menu">
          <div class="menu">
            <ul class="menu-left">
                ...
                <li><a class="active" href="<?php echo e(route('adminME')); ?>">Mail/Export</a></li>
            </ul>
          </div>
        </div>
        <div class="col-lg-10">
...
</html><?php /**PATH D:\StarBoardAsia\SBAinterview\resources\views/pages/adminME.blade.php ENDPATH**/ ?>